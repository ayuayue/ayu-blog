                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <jet-nav-link :href="route('dashboard')" :active="route().current('archive')">
                                    归档
                                </jet-nav-link>
                                <jet-nav-link :href="route('dashboard')" :active="route().current('tag')">
                                    标签
                                </jet-nav-link>
                                <jet-nav-link :href="route('dashboard')" :active="route().current('category')">
                                    分类
                                </jet-nav-link>
                                <jet-nav-link :href="route('dashboard')" :active="route().current('other')">
                                    其他
                                </jet-nav-link>
